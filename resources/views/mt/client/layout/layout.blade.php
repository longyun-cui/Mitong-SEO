...
<div class="wrapper">
    ...
    {{--main-header--}}
    @include('mt.client.component.main-header')

    {{--main-sidebar--}}
    @include('mt.client.component.main-sidebar')

    {{--main-content--}}
    @include('mt.client.component.main-content')

    {{--main-footer--}}
    @include('mt.client.component.main-footer')

    {{--control-sidebar--}}
    @include('mt.client.component.control-sidebar')
