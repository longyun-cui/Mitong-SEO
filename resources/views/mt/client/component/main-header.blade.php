                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            @if(Auth::guard('client')->user()->portrait_img)
                                <img src="{{ url(env('DOMAIN_CDN').'/'.Auth::guard('client')->user()->portrait_img) }}" class="user-image" alt="User Image">
                            @else
                                <img src="/AdminLTE/dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
                            @endif
                            <!-- hidden-xs hides the username on small devices so only the image appears. -->
                            <span class="hidden-xs">{{ Auth::guard('client')->user()->username }}</span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- The user image in the menu -->
                            <li class="user-header">
                                @if(Auth::guard('client')->user()->portrait_img)
                                    <img src="{{ url(env('DOMAIN_CDN').'/'.Auth::guard('client')->user()->portrait_img) }}" class="img-circle" alt="User Image">
                                @else
                                    <img src="/AdminLTE/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
                                @endif
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="{{ url('/client/info/index') }}" class="btn btn-default btn-flat">个人资料</a>
                                </div>
