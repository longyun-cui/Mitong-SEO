...
@section('head_title','关键词查询  - 搜索引擎智能营销系统')
                    ...
                    <table class='table table-striped table-bordered list' id='tablelist'>
                        <thead>
                            <tr role='row' class='heading'>
                                ...
                                <td class="text-center" width="100px">优化周期</td>
                            </tr>
                        </thead>
            ...
            <div class="box-footer">
                <div class="row" style="margin:0;">
                    <div class="col-md-offset-0 col-md-12">
                        <label for="select_all" class="pull-left _none" style="line-height: 30px; padding-right: 20px; color: #5e87b1;">
                    ...
                    <div class="col-md-offset-0 col-md-12">
                        <p class="tip" style="margin-top:4px;color:red">提示:点击关键词和搜索引擎名称可以批量选择</p>
                    </div>
                </div>
            </div>
...
<script>
    $(function() {
        ...
        $("#search-item-submit").on('click', function() {
            var options = {
                url: "{{ url('/client/business/keyword-search') }}",
                type: "post",
                dataType: "json",
                // target: "#div2",
