            ...
            <div class="box-body datatable-body item-main-body" id="item-main-body">
                ...
                <div class="row col-md-12 datatable-search-row">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control form-filter item-search-keyup" name="creator" placeholder="发布者" />

                        <select class="form-control form-filter" name="sort">
...
//                "aLengthMenu": [[20, 50, 200, 500, -1], ["20", "50", "200", "500", "全部"]],
                ...
                "searching": false,
                "ajax": {
                    'url': "{{ url('/admin/notice/notice-list') }}",
                    "type": 'POST',
                    "dataType" : 'json',
                    "data": function (d) {
...
//                            return data;
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            ...
                            if(row.creator_id == "{{ Auth::guard('admin')->user()->id }}")
                            {
                                if(row.active == 0)
                                {
...
//                $('select.form-filter').selectpicker('refresh');
        ...
        $("#item-main-body").on('click', ".item-detail-show", function() {
            ...
            $.ajax({
                ...
                dataType:'json',
                async:false,
                url: "{{ url('/admin/notice/notice-get') }}",
                data: {
