            ...
            <div class="box-body datatable-body item-main-body" id="item-main-body">
                ...
                <div class="row col-md-12 datatable-search-row">
                    <div class="input-group">
                        ...
                        <select class="form-control form-filter" name="latest_ranking" style="width:96px;">
                            <option value ="0">达标状态</option>
                ...
                <table class='table table-striped table-bordered' id='datatable_ajax'>
                    ...
                    <tr class="_none">
                        ...
                        <td>
                            <select class="form-control form-filter" name="searchengine-">
                        ...
                        <td></td>
                        <td>
                            <select class="form-control form-filter" name="latest_ranking-">
                                <option value ="0">全部</option>
                                <option value ="1">已达标</option>
                            </select>
                        </td>
