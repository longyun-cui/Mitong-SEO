...
<div class="wrapper">
    ...
    {{--main-header--}}
    @include('mt.admin.component.main-header')

    {{--main-sidebar--}}
    @include('mt.admin.component.main-sidebar')

    {{--main-content--}}
    @include('mt.admin.component.main-content')

    {{--main-footer--}}
    @include('mt.admin.component.main-footer')

    {{--control-sidebar--}}
    @include('mt.admin.component.control-sidebar')
