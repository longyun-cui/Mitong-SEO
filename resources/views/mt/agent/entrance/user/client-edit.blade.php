...
@section('create-text') 添加客户 @endsection
@section('edit-text') 编辑客户 @endsection
@section('list-text') 客户列表 @endsection
...
@section('breadcrumb')
    ...
    <li><a href="{{ url('/agent/user/client-list') }}"><i class="fa "></i> @yield('list-text')</a></li>
                ...
                <div class="form-group form-category">
                    ...
                    <div class="col-md-8">
                        <div class="btn-group">
                            ...
                            <button type="button" class="btn">
                                <div class="radio">
                                    <label>
                                        ...
                                        {{--<input type="radio" name="usergroup" value="Agent2"--}}
                            ...
                            @if($operate == 'create' || ($operate == 'edit' && $data->usergroup == "Service"))
                            <button type="button" class="btn">
                                <div class="radio">
                                    <label>
...
<script>
    $(function() {
        ...
        $("#edit-item-submit").on('click', function() {
            var options = {
                url: "{{ url('/agent/user/client-edit') }}",
                type: "post",
                dataType: "json",
                // target: "#div2",
                success: function (data) {
                    ...
                    {
                        layer.msg(data.msg);
                        location.href = "{{ url('/agent/user/client-list') }}";
                    }
                }
            };
