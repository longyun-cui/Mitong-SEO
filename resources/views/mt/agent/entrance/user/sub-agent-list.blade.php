...
@section('head_title','子代理商列表 - 代理商后台 - 搜索引擎智能营销系统 - 米同科技')

@section('header','子代理商列表')
            ...
            <div class="box-header with-border" style="margin:16px 0;">
                ...
                <div class="caption">
                    ...
                    <a href="{{ url('/agent/user/sub-agent-create') }}">
                        <button type="button" onclick="" class="btn btn-success pull-right"><i class="fa fa-plus"></i> 添加子代理</button>
                    </a>
                </div>
...
//                "aLengthMenu": [[20, 50, 200, 500, -1], ["20", "50", "200", "500", "全部"]],
                ...
                "searching": false,
                "ajax": {
                    'url': "{{ url('/agent/user/sub-agent-list') }}",
                    "type": 'POST',
                    "dataType" : 'json',
                    "data": function (d) {
    ...
    $(function() {
        ...
        $("#modal-body").on('click', "#item-recharge-submit", function() {
            ...
            layer.msg('确定"充值"么', {
                ...
                ,yes: function(index){
                    ...
                    var options = {
                        url: "{{ url('/agent/user/sub-agent-recharge') }}",
                        type: "post",
                        dataType: "json",
                        // target: "#div2",
        ...
        $("#item-main-body").on('click', ".item-delete-submit", function() {
            ...
            layer.msg('确定"删除"么?', {
                ...
                ,yes: function(index){
                    $.post(
                        "{{ url('/agent/user/sub-agent-delete') }}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            id:that.attr('data-id')
                        },
