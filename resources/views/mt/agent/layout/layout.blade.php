...
<div class="wrapper">
    ...
    {{--main-header--}}
    @include('mt.agent.component.main-header')

    {{--main-sidebar--}}
    @include('mt.agent.component.main-sidebar')

    {{--main-content--}}
    @include('mt.agent.component.main-content')

    {{--main-footer--}}
    @include('mt.agent.component.main-footer')

    {{--control-sidebar--}}
    @include('mt.agent.component.control-sidebar')
